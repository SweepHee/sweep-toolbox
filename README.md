...
항상 바탕화면 위에 떠 있는 스티커 메모 기능입니다.

**메모 생성**
- 앱 내 "새 메모" 버튼으로 생성
- 바탕화면 우클릭 → **"메모장 만들기"** 로 클릭 위치에 바로 생성 (앱 실행 중 여부 무관)

**편집**
- 리치 텍스트 에디터 (굵게 · 기울임 · 밑줄 · 제목1/2 · 글자색)
- 글머리 목록 · 번호 목록 · 체크리스트
- 이미지 삽입 (우클릭 메뉴)
- 글자 크기 조절 (소 · 기본 · 대 · 특대)

**스타일**
- 배경색 변경: 단색 17가지 + 그라데이션 8가지
- 투명도 조절: 20 ~ 100% (바탕화면이 투명하게 비침)

**창 제어**
- 항상 위에 표시 — 다른 앱에 가려지지 않음
- 위치 고정 — 실수로 창이 이동되지 않도록 잠금
- 접기/펴기 — 얇은 탭으로 최소화, 첫 줄이 탭 제목으로 표시

**전체 관리 (앱 내 스티커 메모 탭)**
- 메모 목록: 첫 줄이 제목, 나머지가 미리보기로 표시
- 전체 접기 / 전체 펴기
- 전체 크기 초기화 (기본 280 × 300)
- 전체 정렬: 좌상단 · 우상단 · 좌하단 · 우하단 코너 선택 후 계단식 또는 격자 정렬
